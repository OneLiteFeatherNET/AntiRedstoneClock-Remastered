# AntiRedstoneClock-Remastered documentation

**New here?** [Detect your first redstone clock](tutorial/detect-your-first-clock.md) takes you
from an empty `plugins/` directory to watching the plugin find and break a clock.
